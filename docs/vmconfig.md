...
The following variables are able to be updated after the first successful boot:

- OIDC variables
  - Consumed by: `kube-apiserver`
  - OIDC Issuer `OIDC_ISSUER_URL`
  - OIDC CA `OIDC_CUSTOM_CA` (base64 encoded CA certificate)
